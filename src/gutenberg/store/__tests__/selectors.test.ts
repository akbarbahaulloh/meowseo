...
describe('Selectors', () => {
  ...
  describe('getActiveTab', () => {
    ...
    it('should handle all tab types', () => {
      expect(getActiveTab({ ...mockState, activeTab: 'general' })).toBe('general');
      expect(getActiveTab({ ...mockState, activeTab: 'social' })).toBe('social');
      expect(getActiveTab({ ...mockState, activeTab: 'schema' })).toBe('schema');
      expect(getActiveTab({ ...mockState, activeTab: 'advanced' })).toBe('advanced');
    });
  });
