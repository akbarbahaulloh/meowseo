...
describe('TabContent Component', () => {
  ...
  it('should render only the general tab content when general is active', () => {
    ...
    expect(screen.queryByTestId('tab-panel-social')).not.toBeInTheDocument();
    expect(screen.queryByTestId('tab-panel-schema')).not.toBeInTheDocument();
    expect(screen.queryByTestId('tab-panel-advanced')).not.toBeInTheDocument();
  });
  ...
  it('should render only the social tab content when social is active', () => {
    ...
    expect(screen.queryByTestId('tab-panel-general')).not.toBeInTheDocument();
  ...
  it('should render only the advanced tab content when advanced is active', () => {
    ...
    expect(screen.queryByTestId('tab-panel-social')).not.toBeInTheDocument();
    expect(screen.queryByTestId('tab-panel-schema')).not.toBeInTheDocument();
    expect(screen.getByTestId('tab-panel-advanced')).toBeInTheDocument();
  });
  ...
  it('should not render inactive tab content in the DOM', () => {
    ...
    expect(container.querySelector('#meowseo-tab-panel-general')).toBeInTheDocument();
    expect(container.querySelector('#meowseo-tab-panel-social')).not.toBeInTheDocument();
    expect(container.querySelector('#meowseo-tab-panel-schema')).not.toBeInTheDocument();
    expect(container.querySelector('#meowseo-tab-panel-advanced')).not.toBeInTheDocument();
  });
  ...
  it('should have proper ARIA attributes for active tab panel', () => {
    ...
    expect(socialPanel).toHaveAttribute('id', 'meowseo-tab-panel-social');
    expect(socialPanel).toHaveAttribute('aria-labelledby', 'meowseo-tab-social');
  });
});
