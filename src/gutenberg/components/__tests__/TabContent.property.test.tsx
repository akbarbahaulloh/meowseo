		...
		fc.assert(
			fc.property(
				...
				( activeTab ) => {
					...
					const panel1 = container1.querySelector(
						`#meowseo-tab-panel-${ activeTab }`
					);
					const panel2 = container2.querySelector(
						`#meowseo-tab-panel-${ activeTab }`
					);
