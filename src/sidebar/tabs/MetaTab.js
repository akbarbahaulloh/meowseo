...
export default function MetaTab() {
	...
	const [ metaTitle, setMetaTitle ] = useEntityProp(
		'postType',
		postType,
		'meta',
		'meowseo_title'
	);
	const [ metaDescription, setMetaDescription ] = useEntityProp(
		'postType',
		postType,
		'meta',
		'meowseo_description'
	);
	const [ metaRobots, setMetaRobots ] = useEntityProp(
		'postType',
		postType,
		'meta',
		'meowseo_robots'
	);
	const [ metaCanonical, setMetaCanonical ] = useEntityProp(
		'postType',
		postType,
		'meta',
		'meowseo_canonical'
	);
	const [ focusKeyword, setFocusKeyword ] = useEntityProp(
		'postType',
		postType,
		'meta',
	...
	const robotsOptions = [
		...
		{
			label: __( 'No Index, No Follow', 'meowseo' ),
	...
	return (
		<div className="meowseo-meta-tab">
			<TextControl
				...
				value={ focusKeyword || '' }
				onChange={ ( value ) =>
					handleChange( 'focusKeyword', value, setFocusKeyword )
				}
			...
			<TextControl
				...
				value={ metaTitle || '' }
				onChange={ ( value ) =>
					handleChange( 'title', value, setMetaTitle )
				}
				help={ __(
					'Leave empty to use post title + site title',
					'meowseo'
				) }
			/>
			...
			<TextareaControl
				...
				onChange={ ( value ) =>
					handleChange( 'description', value, setMetaDescription )
				}
			...
			<SelectControl
				...
				onChange={ ( value ) =>
					handleChange( 'robots', value, setMetaRobots )
				}
			/>
			...
			<TextControl
				...
				value={ metaCanonical || '' }
				onChange={ ( value ) =>
					handleChange( 'canonical', value, setMetaCanonical )
				}
